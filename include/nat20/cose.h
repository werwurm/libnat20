...
/**
 * @brief Get the size of the signature for a given signing key algorithm.
 *
 * This function takes a signing key algorithm identifier and returns
 * the size of the signature in bytes.
 *
 * See @ref n20_cose_algorithm_id_s for supported algorithm identifiers.
 *
 * If the signing key algorithm is not supported, the function will return
 * zero.
 *
 * @param signing_key_algorithm_id The algorithm identifier for the signing key.
 * @return size_t The size of the signature in bytes.
 */
