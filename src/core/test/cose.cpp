...
TEST(CoseTest, CoseKeyOpsMaskTest) {
    n20_cose_key_t key = {};
...
TEST(CoseTest, CoseKeyGetSignatureSizeTest) {
    ASSERT_EQ(n20_cose_get_signature_size(n20_cose_algorithm_id_es256_e), 64);
    ASSERT_EQ(n20_cose_get_signature_size(n20_cose_algorithm_id_esp256_e), 64);
    ASSERT_EQ(n20_cose_get_signature_size(n20_cose_algorithm_id_es384_e), 96);
    ASSERT_EQ(n20_cose_get_signature_size(n20_cose_algorithm_id_esp384_e), 96);
    ASSERT_EQ(n20_cose_get_signature_size(n20_cose_algorithm_id_eddsa_e), 64);
    ASSERT_EQ(n20_cose_get_signature_size(n20_cose_algorithm_id_ed25519_e), 64);
    ASSERT_EQ(n20_cose_get_signature_size((n20_cose_algorithm_id_t)999), 0);
}
